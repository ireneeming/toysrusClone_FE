    ...
    <>
      <Grid header>
          <Grid contentWrap>
            <Grid className="flexEnd" header height="34px;">
              <Grid className="flexSpaceBetween" width="246px;">
                <Grid lineHeight="34px;" _onClick={()=>{history.push('/login');}}><Text className="headerInfo" >로그인</Text></Grid>
                <Grid lineHeight="34px;" _onClick={()=>{history.push('/register');}}><Text className="headerInfo">회원가입</Text> </Grid>
                <Grid lineHeight="34px;" ><Text className="headerInfo">주문배송</Text> </Grid>
                <Grid lineHeight="34px;"><Text className="headerInfo">고객센터</Text> </Grid>
              </Grid>
            </Grid>
